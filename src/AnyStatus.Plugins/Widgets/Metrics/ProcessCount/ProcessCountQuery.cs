...
namespace AnyStatus
{
    public class ProcessCountQuery : IMetricQuery<ProcessCount>
    {
        private const string CategoryName = "System";
        private const string CounterName = "Processes";

        [DebuggerStepThrough]
        public async Task Handle(MetricQueryRequest<ProcessCount> request, CancellationToken cancellationToken)
        {
